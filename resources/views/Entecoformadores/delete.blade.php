...
<head>
    <meta charset="UTF-8">
    <title>Eliminar Ente Coformador</title>
    ...
    <div class="content-wrapper p-4">
        ...
        <section class="content">
            <div class="card card-danger">
                ...
                <form action="{{ route('entecoformadores.destroy', $dato->NIS) }}" method="POST" id="deleteForm">
                    @csrf
                    @method('DELETE')
                    <div class="card-body">
                        <p>¿Estás seguro de que deseas eliminar el ente coformador <strong>{{ $dato->Nombres ?? $dato->RazonSocial }}</strong>?</p>
                    </div>
