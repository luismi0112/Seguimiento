...
<head>
    <meta charset="UTF-8">
    <title>Agregar Centro de Formación</title>
    @vite([
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card card-primary">
                        ...
                        <form id="formCentro" action="{{ route('centrosformacion.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="regional" name="tblregionales_NIS" required>
                                        ...
                                        <option value="{{ $regional->NIS }}">{{ $regional->Denominacion }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                .then(data => {
                    if (data.success) {
                        Swal.fire({
                            ...
                            text: 'El centro de formación se guardó correctamente.',
